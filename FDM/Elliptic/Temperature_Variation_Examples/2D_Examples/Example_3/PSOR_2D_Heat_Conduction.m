% Temperature Variation Example-3 using PSOR Method

% Known Parameters
Lx = 2; % Length of domain along x-direction
...
% Boundary Conditions
T(N,:) = 200; % Bottom Boundary T = 200R (R - Rankine)
T(1,:) = 0; % Top Boundary T = 0R
T(:,1) = 0; % Left Boundary T = 0R
T(:,M) = 0; % Right Boundary T = 0R
